...
The service is split into backend (`esm2/dynamo/backend.py`) and frontend (`esm2/dynamo/frontend.py`) components. Docker and Docker Compose is used to make setup simple.
