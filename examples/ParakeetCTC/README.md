...
title: "Nemo ASR Parakeet CTC 0.6B Pipeline Tuning"
---
...
To run ParakeetCTC as an AI Dynamo service, you need to first tune your model and then launch a test run using the provided script.
