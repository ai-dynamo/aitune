...
"""Test distributed AOT tuning of Transformers native TP with TorchInductor JIT.
...
def test_tune_transformers_native_tp_inductor_backend() -> None:
    """Tune and run a native-TP model with the Inductor backend through the explicit tuning flow."""
    run_aot_native_tp_test(
        TorchInductorJitBackend,
        "transformers-native-tp-inductor-jit",
        __file__,
    )
...
if __name__ == "__main__":
    ...
    test_tune_transformers_native_tp_inductor_backend()
