...
import aitune.torch.kernel_forge.kernel_optimizer as kernel_optimizer_module
...
def test_make_plan_returns_when_no_kernel_candidates(caplog):
    ...
    with caplog.at_level(logging.INFO, logger="aitune.torch.kernel_forge.kernel_optimizer"):
