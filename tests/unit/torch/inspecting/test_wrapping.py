...
def test_wrap_root_module(simple_model):
    ...
    wrapped_model = wrap(
        simple_model,
        [
            ModuleInfo(name=None, module=simple_model, parent=None),
        ],
    )
...
def test_wrap_submodule(nested_model):
    ...
    parent = ModuleInfo(name=None, module=nested_model, parent=None)
...
def test_wrap_module_execution(simple_model):
    ...
    wrapped_model = wrap(simple_model, [ModuleInfo(name=None, module=simple_model, parent=None)])
...
def test_wrap_custom_object():
    ...
    module_info = [ModuleInfo(name="model", module=custom_obj.model, parent=None)]
...
def test_wrap_custom_object_nested():
    ...
    module_info = [ModuleInfo(name="layer", module=custom_obj.layer, parent=None)]
...
def test_wrap_custom_object_multiple_modules():
    ...
    module_info = [
        ModuleInfo(name="model1", module=custom_obj.model1, parent=None),
        ModuleInfo(name="model2", module=custom_obj.model2, parent=None),
    ]
