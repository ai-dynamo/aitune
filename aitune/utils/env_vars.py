...
AITUNE_KERNEL_GENERATION_TIMEOUT = float(os.environ.get("AITUNE_KERNEL_GENERATION_TIMEOUT", 6 * 60 * 60))

AITUNE_DISABLE_ONNX_MODEL_COPY = get_bool_env_variable("AITUNE_DISABLE_ONNX_MODEL_COPY", False)
